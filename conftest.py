...
def aiida_localhost_computer(new_workdir):
    ...
    """
    from aiida_bigdft.helpers import get_computer
...
def aiida_code(aiida_localhost_computer):
    ...
    """
    from aiida_bigdft.helpers import get_code

    code = get_code(entry_point='bigdft', computer=aiida_localhost_computer)
