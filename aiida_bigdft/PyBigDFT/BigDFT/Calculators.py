...
class Runner():
    ...
    def _run_options(self, **kwargs):
        ...
        """ :py:class`dict`: Local options of process_run.
         This dictionary can be accessed during the definition of the process_run method.
...
class SystemCalculator(Runner):
    ...
    def process_run(self, command):
        ...
        # Set the number of omp threads only if the variable is not present in the environment
    ...
    def _get_command(self):
        ...
        if dry_run:
            ...
            if run_names:                 command += ' -r ' + run_names
