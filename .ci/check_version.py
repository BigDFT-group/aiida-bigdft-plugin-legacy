...
Check version number in setup.json and aiida_bigdft/__init__.py and make sure
they match.
"""
...
import aiida_bigdft  # pylint: disable=wrong-import-position
version = aiida_bigdft.__version__
